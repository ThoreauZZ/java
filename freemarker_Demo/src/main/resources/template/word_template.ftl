				...
				<w:body>
					...
					<w:p>
						...
						<w:r>
							...
							<w:t>用word编辑模版，需要放入的字符有,保存为xml格式，使用时改成ftl格式。</w:t>
						</w:r>
					</w:p>
					<w:p>
						<w:pPr>
	...
	<pkg:part pkg:name="/docProps/app.xml"
		...
		<pkg:xmlData>
			<Properties
				...
				<Application>WPS
					Office_10.1.0.5400_F1E327BC-269C-435d-A152-05C5408002CA
				</Application>
	...
	<pkg:part pkg:name="/docProps/core.xml"
		...
		<pkg:xmlData>
			<cp:coreProperties
				...
				<dc:creator>henry.zhao</dc:creator>
				<cp:lastModifiedBy>henry.zhao</cp:lastModifiedBy>
				<dcterms:modified xsi:type="dcterms:W3CDTF">2015-12-05T15:58:18Z
				</dcterms:modified>
				<cp:revision />
			</cp:coreProperties>
		</pkg:xmlData>
	...
	<pkg:part pkg:name="/word/numbering.xml"
		...
		<pkg:xmlData>
			<w:numbering
				...
				<w:abstractNum w:abstractNumId="1449330994">
					<w:nsid w:val="56630932" />
					<w:multiLevelType w:val="singleLevel" />
					<w:tmpl w:val="56630932" />
				...
				<w:num w:numId="1">
					<w:abstractNumId w:val="1449330994" />
				</w:num>
			</w:numbering>
		</pkg:xmlData>
	</pkg:part>
