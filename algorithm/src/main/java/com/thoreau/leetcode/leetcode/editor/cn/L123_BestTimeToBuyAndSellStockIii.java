...
public class L123_BestTimeToBuyAndSellStockIii {
    ...
    class Solution {
         ...
         * buy1,seller1,buy2,seller2。比如我就第i天才进行了一笔买入，那利润就是-price[i]，如果i+1卖出，
         * 利润就是-price[i]+price[i+1]
         * <p>
         * buy1：买入-price[i]，或者不变buy1[i-1]
         * buy1[i]=MAX{buy1[i-1],-price[i]}
         * <p>
         * seller1: 不动seller1[i-1]，或者卖出 buy1[i-1]-price[i]
         * seller1[i]=MAX{seller1[i-1],buy1[i-1]+price[i]}
         * <p>
         * 同理：
         * buy2[i]=MAX{buy2[i-1],seller1[i]-price[i]}
         * seller2[i]=MAX{seller2[i-1],buy2[i-1]+price[i]}
         * <p>
