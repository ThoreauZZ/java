...
public class BinarySearchTreeTest {
    ...
    public void findLCATest() {
        ...
        assertEquals(3, tree.findLCA(2, 4));
        assertEquals(5, tree.findLCA(2, 8));
        assertEquals(8, tree.findLCA(7, 8));
        assertEquals(9, tree.findLCA(7, 10));
        assertEquals(5, tree.findLCA(5, 1));
        assertEquals(5, tree.findLCA(2, 7));
    }
}
